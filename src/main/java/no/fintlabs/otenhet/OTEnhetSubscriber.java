...
public class OTEnhetSubscriber extends ResourceSubscriber<OtEnhetResource, OTEnhetPublisher> {
    ...
    protected OTEnhetSubscriber(WebClient webClient, AdapterProperties props, OTEnhetPublisher publisher, ValidatorService validatorService) {
    ...
    @Override
    protected SyncPageEntry createSyncPageEntry(OtEnhetResource resource) {
